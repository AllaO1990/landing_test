...
export class PortfolioFacade {
  ...
  readonly balanceToday$: Observable<null | AccountBalance> = this._store.portfolio.balanceToday$;
  ...
  readonly loadTodayBalance = this._store.portfolio.loadTodayBalance;
