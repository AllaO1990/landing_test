...
export class SelectFacade {
  ...
  readonly instrument$: Observable<null | string> = this._select.instrument$;
  // readonly position$: Observable<null | StockTransaction> = this._select.position$;
  readonly idea$: Observable<null | StockId> = this._select.idea$;
  ...
  updateGroup(group: null | string): void {
