...
export class ApiStructureService {
	...
	getAccountStructure(params: Params): Observable<Response<AccountStructure | null>> {
		return this.#http.post<Response<AccountStructure | null>>(`${this.host}/v1/account/portfolios/structure`, {
