...
export interface FilterDealValue {
	type: AccountType;
...
export class FilterDealListComponent implements ControlValueAccessor, AfterViewInit {
	...
	stringifyPortfolios = signal((x: AccountPortfolio) => x.portfolio || '');
	identityMatcherPortfolios = signal((a: AccountPortfolio, b: AccountPortfolio) => a.portfolioId === b.portfolioId);
