...
@Component({
  selector: 'lib-chart',
  standalone: true,
  imports: [AsyncPipe, ChartComponent, ButtonWithListComponent, ReactiveFormsModule, JsonPipe, TuiLoaderModule, NgIf],
...
export class MainChartComponent {
  ...
  readonly controlEma: FormControl<IndicatorListItem[] | null> = new FormControl(null);
  readonly controlSma: FormControl<IndicatorListItem[] | null> = new FormControl(null);
